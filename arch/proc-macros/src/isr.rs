...
pub fn isr_x86_64(ts: TokenStream) -> TokenStream {
        ...
        fn to_tokens(&self, tokens: &mut quote::__private::TokenStream) {
            ...
            tokens.extend(quote! {
                ...
                unsafe extern "C" fn #handler_name (
                    stack_frame: *mut ::arch::cpu::x86_64::isr::StackFrame,
                ) -> *mut ::arch::cpu::x86_64::isr::StackFrame {
                    { #func };
                    ::arch::fam::x86::pic::end_of_interrupt();
                    stack_frame
                }
                extern "C" {
                    fn #ident();
